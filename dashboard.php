      ...
      >
        ...
        >
          <div class="sidebar-brand-icon">
            <img src="img/rosariologo.png" alt="Municipality Logo" class="logo" style="height: 50px; width: 50px; border-radius: 50%; object-fit: cover;"/>
          </div>
          <div class="sidebar-brand-text mx-2" style="font-size: 12px; text-align: left;">Tourism Office <br> <p style="font-size: 9px;">Municipality of Rosario</p></div>
        </a>
        ...
        <li class="nav-item active">
          <a class="nav-link" href="#">
            <i class="fas fa-fw fa-tachometer-alt"></i>
            <span>Scheduled Field Trips</span>
          </a>
        </li>
